...
shinyUI(
    navbarPage("Shiny Application",
               ...
               tabPanel("Regression Models",
                        h2("Look at the topic at Coursera"),
                        hr(),
               ...
               tabPanel("look at the files",
                        a("https://github.com/pereznavy/Shiny-Application-and-Reproducible-Pitch"),
                        hr(),
                        h2("Thanks for watching"),
                        h2("DDP Assignment week 4")
               )
    )
)
